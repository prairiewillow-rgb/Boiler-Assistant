/*
 * ============================================================
 *  Boiler Assistant – EEPROM Storage Module (v2.1 – Ember Guardian)
 *  ------------------------------------------------------------
 ...
 *
 *  v2.1 Additions:
 *      - NEW: probeRoleMap[8] stored at addresses 30–37
 *      - NEW: Version byte bumped to 2
 *      - NEW: Backward compatibility auto-repair for v2.0 → v2.1
 *      - NEW: Ember Guardian minutes stored + validated
 *
 *  Architectural Notes:
 *      - EEPROM layout is fixed and versioned
 *      - All values validated before saving
 *      - All writes use EEPROM.put() to avoid fragmentation
 *
 *  Version:
