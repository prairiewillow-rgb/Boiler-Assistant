/*
 * ============================================================
 *  Boiler Assistant – EEPROM Storage API (v2.1 – Ember Guardian)
 *  ------------------------------------------------------------
 ...
 *          - Backward compatible with v2.0 layouts
 *
 *  v2.1 Additions:
 *      - NEW: probeRoleMap[8] persistent storage
 *      - NEW: emberGuardMinutes stored + validated
 *      - NEW: loadProbeRoles() and loadAll() API
 *
 *  Version:
...
/* ============================================================
 *  DS18B20 PROBE ROLE MAPPING (v2.1)
 * ============================================================ */
